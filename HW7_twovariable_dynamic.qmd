...
# set parameter list
pars <- c(rprey = 0.1, alpha = 0.6, eff = 0.8, pmort = 0.4, K = 20, hunt = 0.5)
...
hunt <- runif(min = 0.01, max = 0.5, n = np)

X1 <- cbind.data.frame(rprey = rprey, K = K, alpha = alpha, eff = eff, pmort = pmort, hunt = hunt)
...
X2 <- cbind.data.frame(rprey = rprey, K = K, alpha = alpha, eff = eff, pmort = pmort, hunt = hunt)
